        ...
        <div class="cont">
            ...
            <div class="area_form clearfix">
                <div class="clearfix">
                    ...
                    <input type="button" name="name" id="AddAuthor" value="添加" class="btn fr mr10" onclick="javascript: OpenIFrameWindow('添加作者','AddAchMember.aspx?tb=AuthorInfo&pagesize=5', '80%', '70%');" />

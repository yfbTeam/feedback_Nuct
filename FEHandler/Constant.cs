            ...
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    CourseRoom t = new CourseRoom()
                    {
                        ...
                        TeacherDepartmentName = Convert.ToString(dr["TeacherDepartmentName"]),
            ...
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    Eva_TableDetail t = new Eva_TableDetail()
                    {
                        ...
                        Name = Convert.ToString(dr["Name"]),
                        OptionA = Convert.ToString(dr["OptionA"]),
                        OptionA_S = Convert.ToDecimal(dr["OptionA_S"]),
                        OptionB = Convert.ToString(dr["OptionB"]),
                        OptionB_S = Convert.ToDecimal(dr["OptionB_S"]),
                        OptionC = Convert.ToString(dr["OptionC"]),
                        OptionC_S = Convert.ToDecimal(dr["OptionC_S"]),
                        OptionD = Convert.ToString(dr["OptionD"]),
                        OptionD_S = Convert.ToDecimal(dr["OptionD_S"]),
                        OptionE = Convert.ToString(dr["OptionE"]),
                        OptionE_S = Convert.ToDecimal(dr["OptionE_S"]),
                        OptionF = Convert.ToString(dr["OptionF"]),
                        OptionF_S = Convert.ToDecimal(dr["OptionF_S"]),
                        OptionF_S_Max = Convert.ToDecimal(dr["OptionF_S_Max"]),
                        QuesType_Id = Convert.ToInt32(dr["QuesType_Id"]),
                        Remarks = Convert.ToString(dr["Remarks"]),

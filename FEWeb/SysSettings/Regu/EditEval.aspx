<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditEval.aspx.cs" Inherits="FEWeb.SysSettings.Regu.EditEval" %>
...
<script>
    ...
    $(function () {
        Get_Eva_RegularSingle(reguType);
    });

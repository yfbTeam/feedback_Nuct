...
(function($){
	...
	$.fn.kkPages = function(options){
		...
		return this.each(function(){		
			...
			var $IsShow = opts.IsShow;//是否显示前后
			
			
			// 定义分页导航
			var PagesNavHtml = "<div class=\"Pagination\">";

			PagesNavHtml += "<a href=\"javascript:;\" class=\"homePage\">首页</a><a href=\"javascript:;\" class=\"PagePrev\">上一页</a>";
			
			PagesNavHtml += "<span class=\"Ellipsis\">";
			PagesNavHtml += "<b>...</b>";
			PagesNavHtml += "</span><div class=\"pagesnum\"></div><span class=\"Ellipsis\">";
			PagesNavHtml += "<b>...</b>";
			PagesNavHtml += "</span>";
			if ($IsShow == true)
			{
			    PagesNavHtml += "<a href=\"javascript:;\" class=\"PageNext\">下一页</a><a href=\"javascript:;\" class=\"lastPage\">尾页</a><cite class=\"FormNum\">直接到第<input type=\"text\" name=\"PageNum\" id=\"PageNum\">页</cite><a href=\"javascript:;\" class=\"PageNumOK\">确定</a>";
			} else {
			    PagesNavHtml += "<a href=\"javascript:;\" class=\"PageNext\">下一页</a><a href=\"javascript:;\" class=\"lastPage\">尾页</a>";
			}
			...
			if($AllMth > $Mth){
					...
					if ($IsShow == true)
					{
					    PagesMthTxt = "<span>共<b>" + $AllMth + "</b>条，共<b>" + PagesMth + "</b>页</span>";
					}

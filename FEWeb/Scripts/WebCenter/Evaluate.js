...
var SourceType = '', Ans_IsSelfStart = '';//评价任务来源 1院管理员；2校管理员
var TeacherMajor_ID = login_User.Major_ID;
...
function Get_Eva_QuestionAnswer(PageIndex, SectionID, DepartmentID, Key, TableID) {
    ...
    $.ajax({
        ...
        data: {
            ...
            SourceType: SourceType, IsSelfStart: Ans_IsSelfStart, TeacherMajor_ID: TeacherMajor_ID
        },
        dataType: "json",
